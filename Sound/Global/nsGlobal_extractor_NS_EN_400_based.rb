...
module MPONExtract
  ...
  def self.read_merge_nsglobal_400_headers(ns_en_offsets, wad_fp)
    puts "Reading: #{wad_fp} [NSGLOBAL_400 HEADERS] ..."
  ...
  def self.read_merge_nsf_en_158_headers(ns_en_offsets, wad_fp)
    puts "Reading: #{wad_fp} [NSF_EN_158 HEADERS] ..."
  ...
  def self.read_merge_nsd_en_158_headers(ns_en_offsets, wad_fp)
    puts "Reading: #{wad_fp} [NSD_EN_158 HEADERS] ..."
...
MPONExtract::read_merge_nsglobal_400_headers(ns_en_offsets, wad_fp)
MPONExtract::read_merge_nsf_en_158_headers(ns_en_offsets, f_wad_fp)
MPONExtract::read_merge_nsd_en_158_headers(ns_en_offsets, d_wad_fp)


# MPONExtract::extract_streams_nsglobal_400(ns_en_offsets, wad_fp, adb_data, extract_path)
# MPONExtract::extract_streams_nsf_en_158(ns_en_offsets, f_wad_fp, adb_data, extract_path)
MPONExtract::extract_streams_nsd_en_158(ns_en_offsets, d_wad_fp, adb_data, extract_path)